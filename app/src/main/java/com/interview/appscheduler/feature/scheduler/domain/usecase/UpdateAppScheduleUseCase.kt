...
) : AbstractUseCase<Flow<Result<Entity<Int>>>, AppEntity> {
    override suspend fun invoke(): Flow<Result<Entity<Int>>> = TODO("Not yet implemented")

    override suspend fun invoke(params: AppEntity): Flow<Result<Entity<Int>>> = repository.updateAppSchedule(params)
}